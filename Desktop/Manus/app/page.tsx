        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/10 shadow-2xl">
            ...
            <div className="space-y-1">
              <div className="grid grid-cols-4 gap-4 items-center py-1 border-b border-white/10">
              ...
              <div className="grid grid-cols-4 gap-4 items-center py-1 border-b border-white/5">
                ...
                <span className="text-xs font-apple-medium text-white/70 tracking-wide">Relaxing, Sleepy</span>
              ...
              <div className="grid grid-cols-4 gap-4 items-center py-1 border-b border-white/5">
                ...
                <span className="text-xs font-apple-medium text-purple-400 tracking-wide">Myrcene</span>
                <span className="text-xs font-apple-medium text-white/70 tracking-wide">Relaxing, Euphoric</span>
              ...
              <div className="grid grid-cols-4 gap-4 items-center py-1 border-b border-white/5">
                ...
                <span className="text-xs font-apple-medium text-purple-400 tracking-wide">Myrcene</span>
                <span className="text-xs font-apple-medium text-white/70 tracking-wide">Relaxing, Happy</span>
          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/10 shadow-2xl">
            ...
            <div className="space-y-1">
              ...
              <div className="grid grid-cols-4 gap-4 items-center py-1 border-b border-white/5">
                ...
                <span className="text-xs font-apple-medium text-purple-400 tracking-wide">Myrcene</span>
                <span className="text-xs font-apple-medium text-white/70 tracking-wide">Energetic, Creative</span>
              ...
              <div className="grid grid-cols-4 gap-4 items-center py-1 border-b border-white/5">
                ...
                <span className="text-xs font-apple-medium text-white/70 tracking-wide">Uplifting, Creative</span>
              ...
              <div className="grid grid-cols-4 gap-4 items-center py-1 border-b border-white/5">
                ...
                <span className="text-xs font-apple-medium text-yellow-400 tracking-wide">Terpinolene</span>
                <span className="text-xs font-apple-medium text-white/70 tracking-wide">Energetic, Euphoric</span>
              ...
              <div className="grid grid-cols-4 gap-4 items-center py-1">
                ...
                <span className="text-xs font-apple-medium text-green-400 tracking-wide">Caryophyllene</span>
                <span className="text-xs font-apple-medium text-white/70 tracking-wide">Energetic, Uplifting</span>

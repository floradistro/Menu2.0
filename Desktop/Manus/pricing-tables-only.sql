-- PRICING TABLES ONLY - Run this in Supabase SQL Editor
-- This script only creates pricing tables and won't conflict with existing tables

-- Drop existing pricing tables if they exist (to start fresh)
